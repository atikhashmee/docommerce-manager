...
class PricingInventoryStepTwo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            spinner: false,
        ...
        return (
            <View style={Styles.container}>
                ...
                <AnimScrollView style={[Styles.topContainer]}>
                    <Styles.PageHeader>Pricing & Inventory -- 2</Styles.PageHeader>
                    <FormGroup>
...
export default connect(mapStateToProps)(PricingInventoryStepTwo);
